...
Link for the dataset https://www.kaggle.com/datasets/arnavsmayan/netflix-userbase-dataset
...
Subscription_Type:
Description: Type of subscription the user has (e.g., Basic, Premium, Standard).

Monthly_Revenue:
Description: The revenue generated monthly from the user's subscription.

Join_date_new:
Description: The date when the user subscribed to the service.

Last_Payment_Date_modify:
Description: The most recent payment date for the user.
...
Device:
Description: The primary device used by the user (e.g., Smartphone, Laptop).

Plan_Duration:
Description: Duration of the subscription plan (e.g., 1 Month, 6 Months).
